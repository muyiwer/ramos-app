  ...
  return (
    ...
    <div className="grid grid-cols-[1.5fr_1fr] gap-4  mt-[40px]">
      <div className="grid grid-cols-2  py-7 pl-7 h-[310px] rounded-[30px] border-[1px] border-gray-300 bg-white">
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <span className=" text-gray-500 w-[80%] text-[12px]">
              One platform is a comprehensive system of solutions that will
              be the first step towards digitalization of your business
            </span>
          </div>
        </div>
        <div className="border-gray-300 rounded-l-[20px] border-[1px] p-3 grid grid-row-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-3 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-bold text-[1.2rem]">$ 264.2k</span>
                </div>
              </div>
            </div>
      ...
      <div className="h-[310px] grid grid-rows-2 gap-5 bg-[#0d0d0d] rounded-[30px] w-full py-[40px] px-[60px]">
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="border-[#292929] relative text-white h-[140px] border-[2px] bg-[#171717] rounded-[25px] flex flex-col gap-5 items-center justify-center">
            ...
            <span className="text-[2.5rem]">43K</span>
          </div>
        </div>
    ...
    <div className="flex justify-center mt-5 gap-6 items-center">
        ...
        <span className="w-[400px] text-[13px]">
          ...
          for making important, informed information
        </span>
      </div>
  </div>
  )
